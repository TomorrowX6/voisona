...
try {
  ...
  $c18 = & $hex (0x400+(0x1409F4442-0x140001000)) 4
  "source checks: p1=$c1 p8=$c8 p9=$c9 p11=$c11 p13=$c13 p14=$c14 p16=$c16 p17=$c17 p18=$c18" | Out-File $log -Append
  ...
  if($c18 -ne '49 8B 45 20'){ "abort: p18 wrong" | Out-File $log -Append; exit 1 }
